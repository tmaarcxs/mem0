...
For per-client setup and advanced options, see [Mem0 MCP Setup](/platform/mem0-mcp). For OpenCode's full plugin with prompt-time recall and compaction hooks, see [OpenCode](/integrations/opencode).
